...
function umb_tabs_wizard(){
    ...
    <script type="text/javascript">
        jQuery('#aes-submit').click(function () {
            var shortcode = "[<?php echo $_GET["shortcode1"]; ?>]";
            jQuery("table.um_tabs tr:gt(0)").each(function () {
                ...
                var tmpshortcode = '[<?php echo $_GET["shortcode2"]; ?> title="' + title + '"]' + content + '[/<?php echo $_GET["shortcode2"]; ?>]';
                shortcode += tmpshortcode;
            });
            shortcode += "[/<?php echo $_GET["shortcode1"]; ?>]";
...
function umb_buttons_wizard(){
    ...
    <script>
        jQuery(document).ready(function ($) {
            $("#aes-submit").click(function () {
                ...
                var type = $("#type").val();
                var color = $("#color").val();
                umb_active_tiny_mce.selection.setContent('[button url="'+URL+'" type="'+type+'" color="'+color+'"]'+umb_active_tiny_mce.selection.getContent()+'[/button]');
                tb_remove();
            });
        });
    </script>
    ...
    <select id="type">
        ...
        <option value="small arrow">Arrow</option>
